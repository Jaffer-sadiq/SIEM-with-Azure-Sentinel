...
3. On the **Add Microsoft Sentinel to a Workspace** page, select the existing workspace i.e., **log-contoso-diagnosticworkspace-<inject key="Deployment-id" enableCopy="false"> (1)** which was created in the previous 
