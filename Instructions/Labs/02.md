...
3. Select **Hunting** under the **Threat management** section, follow the below instructions to create a new hunt based on the installed **Log4J Vulnerability Detection** solution:
   ...
   ![create hunt configs](../media/newup1.jpg)

   >**Note**: Wait for the **successfully created new hunt** notification.

4. Select **Hunting (1)** under the **Threat management** section within the left navigation pane of the Microsoft Sentinel page, and then click on the **Hunts (Preview) (2)** tab in order to view the newly created 
   hunt.
...
3. On the **Create hunt** page, follow the below instructions to create a new hunt:
   ...
   ![create wse and m365 hunt](../media/wse-m365-hunting.png)
